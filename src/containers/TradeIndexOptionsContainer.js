...
class TradeIndexOptionsContainer extends Component {
  ...
  render() {
    const { handleToggleAsc, handleToggleLarge, handleSelectSort, handleToggleShowPinned, handleAutoPin } = this;
    const { options } = this.props;
    const { sortBy, asc, large, showPinned } = options.toJS();
